...
describe('HomeComponent', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([]), HttpClientTestingModule, HttpClientModule],
  ...
  it('should retrieve Movies - MockData', async () => {

    const expectedUrl = `${environment.apiUrl}/${environment.apiaddress}?api_key=${environment.key}&page=1`;
